const generalPriestAbilities = [
  ...
  console.log(generalPriestAbilities);
  const holyPriestAbilities = [
    {
      id: 1,
      spellId: 2060,
      name: 'Heal',
  ...
  console.log(holyPriestAbilities);

  const disciplinePriestAbilities = [
    {
      id: 1,
      spellId: 17,
      name: 'Power Word: Shield',
  ...
  console.log(disciplinePriestAbilities);

  const shadowPriestAbilities = [
    {
      id: 1,
      spellId: 8092,
      name: 'Mind Blast',
  ...
  console.log(shadowPriestAbilities);
  ...
  console.log(archonTalents);
  console.log(oracleTalents);
  console.log(voidweaverTalents);
